...
CREATE TABLE business_costs (
    ...
    cost_category TEXT NOT NULL CHECK(cost_category IN (
        'rent',              -- 5. Gharama za sehemu
        'electricity',       -- 6. Gharama ya umeme
        'loan_interest',     -- 7. Gharama za mkopo
        'storage',           -- 8. Gharama ya kuhifadhi
        'marketing',         -- 9. Gharama za promotion
        'insurance',         -- 10. Bima ya biashara
        'other'              -- 11. Other expenses
    )),
    description TEXT NOT NULL,
    amount REAL NOT NULL,
    cost_date DATE NOT NULL,
    frequency TEXT CHECK(frequency IN ('one_time', 'daily', 'weekly', 'monthly', 'yearly')) DEFAULT 'monthly',
    recurring_end_date DATETIME, -- For recurring costs
